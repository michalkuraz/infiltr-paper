...
\item the first run for $r_l$=0 generated after 40.000 objective function calls (each call took approx. 3min., executed on 32-core Intel XEON...) the following list of extremes
...
\item red produced bad fit, cyan produced good fit

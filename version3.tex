...
GRADE project is capable for multi-objective definition for the objective function, which is achieved with so-called
 ...
 Since achieving the fully converged solution with genetic algorithms is often cumbersome, the genetic algorithm was used here as an estimator of the initial condition for further gradient parameter search on narrow ranges. For gradient optimization we made use of Newton's method with box-constraints~\citep{byrd1995}, implemented in R environment~\citep{R-env}.
}

...
\mich{In this section a brief description of the conducted experiments is given. Since this contribution is focused on calibration methodology, we will significantly reduce the experimental data description. And so this real-world example will be represented here by a single average data set. Complete statistical description of this experiment is given in~\citep{jacka-site}, whilst effects of the input data variability on the identified SHPs will be covered in another contribution.}


The study site is located in the \v{S}umava National Park, Czech Republic, and has been described in \citep{Jacka1}. The location of the site in a map of Modrava 2 catchment is presented by \cite{Jacka2}.
...
A total of 22 SR experiments were conducted on the site. \mich{In this paper, the experimental data will be represented  by a single average curve, which was analyticaly described by  Swartzendruber analytical model \citep{Swartzendruber}. A detailed description is given in~\citep{jacka-site}. 
 The Swartzendruber equation for cumulative infiltration states that
\begin{lineq}
...
describes one-dimensional infiltration into homogeneous medium, and is therefore not sufficient. The Swartzendruber model was only considered as an  interpolating function.

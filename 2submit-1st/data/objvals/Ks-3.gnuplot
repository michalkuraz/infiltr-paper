...
set label 1 "identified K_s=1.092 cm.hrs^{-1}"
...
# set terminal latex
set output "Ks-3.eps"
plot "results-0-0/Ks-2-par.val" smooth unique w l lw 3 title "r_f=0" , "results-1-1/Ks-3-par.val" smooth unique w l lw 3 title "r_f=1"
#----------------------------------------------------------------------------------

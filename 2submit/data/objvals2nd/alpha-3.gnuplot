...
set label 1 "identified {/Symbol a}=0.0032285 cm^{-1}"
...
plot "coarse/alpha-3-par.val" smooth unique w l lw 3 title "r_f=1" ,  "fine/alpha-3-par.val" smooth unique w l lw 3 title "r_f=2"
#----------------------------------------------------------------------------------

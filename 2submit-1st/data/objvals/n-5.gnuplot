...
set label 1 "identified n= 1.279"
...
# set terminal latex
set output "n-5.eps"
plot "results-0-0/n-4-par.val" smooth unique w l lw 3 title "r_f=0" ,"results-1-1/n-5-par.val" smooth unique w l lw 3 title "r_f=1"
#----------------------------------------------------------------------------------

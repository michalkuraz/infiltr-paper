...
set label 1 "identified n=1.384 for r_f=0"
set grid
...
set label 6 "identified n=1.364 for r_f=1"
...
plot "../../objvals/results-0-0/n-5-par.val" smooth unique w l lw 3 dt 2 linecolor rgb "red"  title "r_f=0, 1^{st} iter." ,  "../../objvals/results-1-1/n6"  smooth unique w l lw 3  dt 2 linecolor rgb "blue" title "r_f=1, 1^{st} iter." , "+" u 1:(NaN) title " " w dots linecolor rgb "white"  , "+" u 1:(NaN) title " " w dots linecolor rgb "white",    "n-2-par.val" smooth unique w l lw 3   linecolor rgb "red"  title   "r_f=1, 2^{nd} iter." ,"rf2/n-2-par.val" smooth unique w l lw 3   linecolor rgb "blue"  title "r_f=2, 2^{nd} iter.", "n2-0.ext" pt 1 ps 5  lc rgb '#008800'  lw 2 notitle , "n2-1.ext" pt 2 ps 5  lc rgb '#880080' lw 2 notitle 

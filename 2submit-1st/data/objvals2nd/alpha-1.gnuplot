...
set label 1 "identified {/Symbol a}=0.0015607 cm^{-1}"
...
# set terminal latex
set output "alpha-1.eps"
plot "coarse/alpha-1-par.val" smooth unique w l lw 3 title "r_f=1" ,  "fine/alpha-1-par.val" smooth unique w l lw 3 title "r_f=2"
#----------------------------------------------------------------------------------

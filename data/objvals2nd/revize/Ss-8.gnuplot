...
set label 1 "identified S_s=1.92e-4 cm^{-1} for r_f=0"
set grid
...
set label 6 "identified S_s=1.92e-4 cm^{-1} for r_f=1"
...
plot "../../objvals/results-0-0/Ss-5-par.val" smooth unique w l lw 3 dt 2 linecolor rgb "red"  title "r_f=0, 1^{st} iter." ,  "../../objvals/results-1-1/Ss-6-par.val"  smooth unique w l lw 3  dt 2 linecolor rgb "blue" title "r_f=1, 1^{st} iter." , "+" u 1:(NaN) title " " w dots linecolor rgb "white"  ,  "+" u 1:(NaN) title " " w dots linecolor rgb "white" , "Ss-2-par.val" smooth unique w l lw 3   linecolor rgb "red"  title   "r_f=1, 2^{nd} iter." ,"rf2/Ss-2-par.val" smooth unique w l lw 3   linecolor rgb "blue"  title "r_f=2, 2^{nd} iter.", "Ss2-0.ext" pt 1 ps 5  lc rgb '#008800'  lw 2 notitle , "Ss2-1.ext" pt 2 ps 5  lc rgb '#880080' lw 2 notitle 

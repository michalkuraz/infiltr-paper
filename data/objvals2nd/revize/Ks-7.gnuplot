...
set label 1 "identified K_s=1.165 cm.h^{-1} for r_f=0"
set grid
...
set label 6 "identified K_s=1.083 cm.h^{-1} for r_f=1"
...
plot "../../objvals/results-0-0/Ks-4-par.val" smooth unique w l lw 3 dt 2 linecolor rgb "red"  title "r_f=0, 1^{st} iter." ,  "../../objvals/results-1-1/Ks-5-par.val"  smooth unique w l lw 3  dt 2 linecolor rgb "blue" title "r_f=1, 1^{st} iter." , "+" u 1:(NaN) title " " w dots linecolor rgb "white"  ,  "+" u 1:(NaN) title " " w dots linecolor rgb "white" , "Ks-1-par.val" smooth unique w l lw 3   linecolor rgb "red"  title   "r_f=1, 2^{nd} iter." ,"rf2/Ks-1-par.val" smooth unique w l lw 3   linecolor rgb "blue"  title "r_f=2, 2^{nd} iter.", "Ks-0.ext" pt 1 ps 5  lc rgb '#008800'  lw 2 notitle , "Ks-1.ext" pt 2 ps 5  lc rgb '#880080' lw 2 notitle 

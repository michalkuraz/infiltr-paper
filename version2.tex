...
The soil texture for the horizons below the top-soil are given in the table~\ref{tab:soiltxt}.\todo{I don't get the percentage, I would probably remove even this table.} 
...
C        &      ??          & ??                          & ??                  & ?? & 1.3 \\ %I am planning to add data next week, I am waiting for additional textural analysis.
\toprule
\end{tabular}
\end{small}
\label{tab:soiltxt}

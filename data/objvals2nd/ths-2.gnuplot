...
set label 1 "identified {/Symbol q}=0.401"
...
# set terminal latex
set output "ths-2.eps"
plot "coarse/ths-2-par.val" smooth unique w l lw 3 title "r_f=1" , "fine/ths-2-par.val" smooth unique w l lw 3 title "r_f=2"
#----------------------------------------------------------------------------------

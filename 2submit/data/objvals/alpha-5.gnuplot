...
set label 1 "identified {/Symbol a}=0.00380 cm^{-1}"
...
plot "results-0-0/alpha-4-par.val" smooth unique w l lw 3 title "r_f=0" ,  "results-1-1/alpha-5-par.val" smooth unique w l lw 3 title "r_f=1"
#----------------------------------------------------------------------------------

...
set label 1 "identified {/Symbol a}=0.00150 cm^{-1}"
...
# set terminal latex
set output "alpha-3.eps"
plot "results-0-0/alpha-2-par.val" smooth unique w l lw 3 title "r_f=0" ,  "results-1-1/alpha-3-par.val" smooth unique w l lw 3 title "r_f=1"
#----------------------------------------------------------------------------------

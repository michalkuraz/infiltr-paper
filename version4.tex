...
A proof for solution uniqueness of this inverse modeling problem wasn't a scope of this paper, however, when reducing the number of unknown parameters by expert knowledge estimate of $\theta_s$, it is believed that the last three parameters, namely $\alpha$, $n$ and $K_s$ could be uniquely defined by the transient part of our SR experiment.

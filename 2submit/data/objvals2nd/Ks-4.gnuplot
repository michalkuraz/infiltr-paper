...
set label 1 "identified K_s=1.0356 cm.hrs^{-1}"
...
# set terminal latex
set output "Ks-4.eps"
plot "coarse/Ks-3-par.val" smooth unique w l lw 3 title "r_f=1" , "fine/Ks-3-par.val" smooth unique w l lw 3 title "r_f=2"
#----------------------------------------------------------------------------------

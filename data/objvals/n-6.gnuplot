...
set label 1 "identified n=1.384 "
...
# set terminal latex
set output "n-6.eps"
plot "results-0-0/n-5-par.val" smooth unique w l lw 3 title "r_f=0" , "results-1-1/n-6-par.val" smooth unique w l lw 3 title "r_f=1"
#----------------------------------------------------------------------------------

...
set label 1 "identified n=1.586 "
...
# set terminal latex
set output "n-3.eps"
plot "results-0-0/n-2-par.val" smooth unique w l lw 3 title "r_f=0" , "results-1-1/n-3-par.val" smooth unique w l lw 3 title "r_f=1"
#----------------------------------------------------------------------------------
